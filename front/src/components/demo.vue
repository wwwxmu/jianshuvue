...
export default {
  ...
  methods: {
    baseInfo (id) {
      ...
      const path = `http://jianshu.weiweiblog.cn/api/base/` + this.$route.params.id
  ...
  created: function () {
    axios.get('http://jianshu.weiweiblog.cn/api/article/' + this.$route.params.id).then(response => {
